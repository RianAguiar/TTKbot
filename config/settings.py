...
import os
SECRET_KEY = os.environ.get('SECRET_KEY','django-insecure-9@%t#t3_c99r5!1ydbj@qpkhvmno&s!(8b-x)$x5#*wel$1n81')
...
CELERY_TIMEZONE = TIME_ZONE  # usa o mesmo timezone já configurado no projeto
